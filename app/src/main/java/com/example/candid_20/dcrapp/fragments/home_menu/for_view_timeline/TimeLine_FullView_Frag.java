...
public class TimeLine_FullView_Frag extends Fragment {
    View v;
    MySharedPref sp;
    ...
    TextView txt_title,txt_selected_datee,txt_selected_strtfieldwork_att,txt_selected_strtfieldwork_locationn,
            ...
            txt_end_time,txt_end_time_value,txt_work_strt_loc,txt_end_location,no_data_available;
    ...
    public static TimeLine_FullView_Frag newInstance()
    {
        TimeLine_FullView_Frag fragment = new TimeLine_FullView_Frag();
        return fragment;
    }
...
//                        // shouldShowRequestPermissionRationale will return true
    ...
    private void initUi() {
        ...
        txt_date_report_error_msg = (TextView)v.findViewById(R.id.txt_selected_date_report_msg);
...
//For  Search DoctorRecycle Create by these
        ...
        LayoutAnimationController animation = AnimationUtils.loadLayoutAnimation(getActivity(), R.anim.layout_animation_slide_right);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (error.equals("success")) {
                        ...
                        String field_work_start_record2 = jObj.getString("field_work_start_record");
                        JSONObject jsonObject4=new JSONObject(field_work_start_record2);
                        String type = jsonObject4.getString("dcr_type");
                         if (type.equalsIgnoreCase("Live"))
                         {
                          ...
                          /*System.out.println("Base URl Old^^^"+str_base_url);
                           ...
                           // Collections.reverse(timeLineMainResult_bean.getResult());
                            ...
                            customSearch_doctors_adp = new CustomSearch_Doctors_Adp(getActivity(), timeLineMainResult_bean.getResult());
                       ...
                       /* if(timeLineMainResult_bean.getResult().getResultStockist().size()>0) {
                            ...
                            customSearch_stockiest_adp = new CustomSearch_Stockiest_Adp(getActivity(),timeLineMainResult_bean.getResult().getResultStockist());
                            InboxDetailRVv.setAdapter(customSearch_stockiest_adp);
                    ...
                    else
                    {
                        ...
                        if(getActivity()!=null) {
                            ...
                            txt_date_report_error_msg.setVisibility(View.VISIBLE);
                            txt_date_report_error_msg.setText("For "+today_date+" the DCR Report is submitted offline.");
                        ...
                        if(getActivity()!=null) {
                            ...
                            txt_date_report_error_msg.setVisibility(View.VISIBLE);
                            txt_date_report_error_msg.setText("For "+today_date+" the DCR Report is not submitted.");
                            //Toast.makeText(getActivity(), "For "+today_date+" the DCR Report is not submitted.", Toast.LENGTH_SHORT).show();
                        }
    ...
    private class CustomSearch_Doctors_Adp extends RecyclerView.Adapter<CustomSearch_Doctors_Adp.MyViewHolder> {
        ...
        public CustomSearch_Doctors_Adp(Activity activity, List<TimeLineResultDoctor_Bean> arr_all_search_doctors2) {
        ...
        public void onBindViewHolder(final CustomSearch_Doctors_Adp.MyViewHolder holder, final int position) {
            ...
            String str_checkiout_time = arr_all_search_doctors3.get(position).getDrCoutT();

            holder.txt_doctor_time.setText(str_checkin_time+" - "+str_checkiout_time);
...
/*
        ...
        private class CustomSearch_Stockiest_Adp extends RecyclerView.Adapter<CustomSearch_Stockiest_Adp.MyViewHolder> {
            ...
            public CustomSearch_Stockiest_Adp(Activity activity, List<TimeLineResultStockiest> arr_all_search_doctors2) {
