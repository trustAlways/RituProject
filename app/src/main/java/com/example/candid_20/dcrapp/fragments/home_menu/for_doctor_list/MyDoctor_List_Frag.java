package com.example.candid_20.dcrapp.fragments.home_menu.for_doctor_list;
...
public class MyDoctor_List_Frag extends Fragment implements View.OnClickListener{
    ...
    Custom_DoctorsList_Adp customSearch_doctors_adp;
    TextView txt_title,txt_total_docter;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {

        v = inflater.inflate(R.layout.my_doctor_list, container, false);
        // ---------------------------- For  Get Saved Data -------------------------------------------------------------------------------//
    ...
    private void initUi() {
        ...
        txt_total_docter = (TextView)v.findViewById(R.id.txt_doctors_count);
        ...
        //Set Text
        txt_title.setText("My Doctors List");
...
*/
    ...
    private void getSaveddata() {
...

        {
            try {
                ...
                System.out.println("Id role is***" + role_id);
    ...
    private void getData_ForSearchSuggestion(final String cityid4) {
        ...
        String url = "http://dailyreporting.in/"+company_name+"/api/doctor_list";
       ...
       /* StringRequest strReq = new StringRequest(Request.Method.POST, URLs.URL_SEARCH_DOCTOR_SUGGETION,
            ...
            public void onResponse(String response) {
                Log.d("doctor list", "All docter List: " + response.toString());
                ...
                try {
                    ...
                    if (error.equals("success")) {
                        ...
                        if(searchDoctor_bean.getResult().size()>0) {
                            ...
                            InboxDetailRV.setLayoutAnimation(animation);
                            customSearch_doctors_adp = new Custom_DoctorsList_Adp(getActivity(), searchDoctor_bean.getResult());
                            InboxDetailRV.setAdapter(customSearch_doctors_adp);

                            txt_total_docter.setVisibility(View.VISIBLE);
                            txt_total_docter.setText(searchDoctor_bean.getResult().size() + "  Doctors");
                           /* rr_InboxDetailRV.setVisibility(View.VISIBLE);
                            InboxDetailRV.setVisibility(View.VISIBLE);*/
                        }
                        }
                        ...
                        if(getActivity()!=null) {
                            ...
                            txt_total_docter.setBackground(getResources().getDrawable(R.drawable.x_et_bg));
                            txt_total_docter.setPadding(10,10,10,10);
                            txt_total_docter.setGravity(CENTER);
                            txt_total_docter.setVisibility(View.VISIBLE);
                            txt_total_docter.setText("Currently No doctor Allocated to you.");
                        }
    ...
    private class Custom_DoctorsList_Adp extends RecyclerView.Adapter<Custom_DoctorsList_Adp.MyViewHolder> {
        ...
        public Custom_DoctorsList_Adp(Activity activity, List<SearchDoctor_LxDetails_Bean> arr_all_search_doctors2) {
        ...
        @Override
        public Custom_DoctorsList_Adp.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View itemView = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.my_doctor_list_adp, parent, false);

            return new Custom_DoctorsList_Adp.MyViewHolder(itemView);
        }

        @Override
        public void onBindViewHolder(final Custom_DoctorsList_Adp.MyViewHolder holder, final int position) {
            ...
            holder.txt_current_loc_descp.setText(position+1+". "+upperString_str_interior_name+" "+"("+upperString_str_specilast+")");

            if(!arr_all_search_doctors3.get(position).getAddress().equalsIgnoreCase(""))
            {
                holder.txt_address.setText("Clinic Address : "+ arr_all_search_doctors3.get(position).getAddress());
            }
            else
            {
                holder.txt_address.setText("Clinic Address : "+ "Not Provided");
            }
       ...
       /*     holder.rr_current_loc_descp.setOnClickListener(new View.OnClickListener() {
        ...
        public class MyViewHolder extends RecyclerView.ViewHolder {
            TextView txt_current_loc_descp,txt_profession,txt_address;
