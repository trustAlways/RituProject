...
public class ItemModelGift {
    ...
    public ItemModelGift(String id1,String index1, String product_name1, String product_quantity1)
    {
    ...
    public ItemModelGift(String edt_product_quantity1)
    {
